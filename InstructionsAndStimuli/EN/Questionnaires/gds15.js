    ...
    [
        {
            ...
            statements: [
                ...
                {prompt: 'Do you feel happy most of the time?', name: 'gds007'},
                {prompt: 'Do you often feel helpless?', name: 'gds008'},
                //{prompt: 'Do you often get restless and fidgety?', name: 'gds011'},
                {prompt: 'Do you prefer to stay at home, rather than going out and doing new things?', name: 'gds009'},
                //{prompt: 'Do you frequently worry about the future?', name: 'gds013'},
                {prompt: 'Do you feel you have more problems with memory than most?', name: 'gds010'},
                {prompt: 'Do you think it is wonderful to be alive now?', name: 'gds011'},
...
var EN_gds15 = {}
EN_gds15.title = 'Geriatric Depression Scale'
EN_gds15.shortTitle = 'GDS-15'
EN_gds15.description = "Choose the best answer for how you felt over the PAST WEEK."
EN_gds15.pages = EN_pages
EN_gds15.QuestionnaireType = 'YesNoLikertTable'
// Yes = 0, No = 1
// Add one point for answers equal to the following responses
EN_gds15.values = [1,0,0,0,1,0,1,0,0,0,1,0,1,0,0]